...
if($result->num_rows > 0){   
    $listaProgresos=array(); //Hace un array y dentro otro llamado RESTAURANTES
	while ($progreso = $result->fetch_assoc()) { //Crea un array asociativo con cada restaurante	
        extract($progreso);//Exporta las variables de un array
