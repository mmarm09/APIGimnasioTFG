...
if($result->num_rows > 0){   
    $listaUsuarios=array(); //Hace un array y dentro otro llamado RESTAURANTES
	while ($usuario = $result->fetch_assoc()) { //Crea un array asociativo con cada restaurante	
        extract($usuario);//Exporta las variables de un array
       ...
       array_push($listaUsuarios, $datosExtraidos);//Hace un append al final de la lista 
    }    
