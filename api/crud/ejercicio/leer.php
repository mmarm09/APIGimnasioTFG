...
if($result->num_rows > 0){   
    $listaEjercicios=array(); //Hace un array y dentro otro llamado RESTAURANTES
	while ($ejercicio = $result->fetch_assoc()) { //Crea un array asociativo con cada restaurante	
        extract($ejercicio);//Exporta las variables de un array
        ...
        array_push($listaEjercicios, $datosExtraidos);//Hace un append al final de la lista 
    }    
    http_response_code(200);     
    echo json_encode($listaEjercicios);
}else{     
